...
class ModWrapperHelper
{
	...
	public static function getParams(&$params)
	{
		...
		$url = $params->get('url');
		if(JFactory::getUser()->id) $url = 'index.php?option=com_users&view=profile&layout=edit&tmpl=component&jsnmodule=1';
		else $url = 'index.php?option=com_users&view=registration&tmpl=component&jsnmodule=1';
