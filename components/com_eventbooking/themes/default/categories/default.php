...
?>
<div id="eb-categories-page" class="eb-container<?php if ($this->config->activate_transparent) echo ' eb-container-transparent'; ?>">
	<?php
		...
		if (count($this->items))
		{
			...
			{
				echo EventbookingHelperHtml::loadCommonLayout('common/categories.php', ['categories' => $this->items, 'categoryId' => $this->categoryId, 'config' => $this->config, 'params' => $this->params, 'Itemid' => $this->Itemid]);
			}
			else
			{
