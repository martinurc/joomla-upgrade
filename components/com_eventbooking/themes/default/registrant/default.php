	...
	<form action="<?php echo Route::_('index.php?option=com_eventbooking&view=registrants&Itemid=' . $this->Itemid); ?>" method="post" name="adminForm" id="adminForm" class="<?php echo $formHorizontalClass; ?>">
		...
		<div class="<?php echo $controlGroupClass; ?>">
			...
			<div class="<?php echo $controlsClass; ?>">
				...
				if ($this->canChangeStatus)
				{
					$input = '<input type="text" class="input-small form-control" name="total_amount" value="' . ($this->item->total_amount > 0 ? round($this->item->total_amount, $numberDecimals) : '') . '" size="7" />';
		...
		if ($this->item->discount_amount > 0 || $this->item->late_fee > 0 || $this->item->tax_amount > 0 || $this->canChangeStatus || empty($this->item->id))
		{
			...
			?>
				<div class="<?php echo $controlGroupClass; ?>">
					...
					<div class="<?php echo $controlsClass; ?>">
						...
						if ($this->canChangeStatus)
						{
							$input = '<input type="text" class="input-small form-control" name="discount_amount" value="' . ($this->item->discount_amount > 0 ? round($this->item->discount_amount, $numberDecimals) : '') . '" size="7" />';
			...
			?>
				<div class="<?php echo $controlGroupClass; ?>">
					...
					<div class="<?php echo $controlsClass; ?>">
						...
						if ($this->canChangeStatus)
						{
							$input = '<input type="text" class="input-small form-control" name="late_fee" value="' . ($this->item->late_fee > 0 ? round($this->item->late_fee, $numberDecimals) : '') . '" size="7" />';
			...
			?>
				<div class="<?php echo $controlGroupClass; ?>">
					...
					<div class="<?php echo $controlsClass; ?>">
						...
						if ($this->canChangeStatus)
						{
							$input = '<input type="text" class="input-small form-control" name="tax_amount" value="' . ($this->item->tax_amount > 0 ? round($this->item->tax_amount, $numberDecimals) : '') . '" size="7" />';
			...
			<div class="<?php echo $controlGroupClass; ?>">
				...
				<div class="<?php echo $controlsClass; ?>">
					...
					if ($this->canChangeStatus)
					{
						$input = '<input type="text" class="input-small form-control" name="amount" value="' . ($this->item->amount > 0 ? round($this->item->amount, $numberDecimals) : '') . '" size="7" />';
		...
		?>
			<div class="<?php echo $controlGroupClass; ?>">
				...
				<div class="<?php echo $controlsClass; ?>">
					...
					if ($this->canChangeStatus)
					{
						$input = '<input type="text" class="input-small form-control" name="deposit_amount" value="' . round($this->item->deposit_amount,
