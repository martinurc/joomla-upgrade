...
$headerText = EventbookingHelper::replaceUpperCaseTags($headerText, $replaces);
...
<div id="eb-deposit-payment-page" class="eb-container">
    ...
    <form method="post" name="adminForm" id="adminForm"
          action="<?php echo Route::_('index.php?option=com_eventbooking&task=payment.process_registration_payment&Itemid=' . $this->Itemid, false); ?>"
