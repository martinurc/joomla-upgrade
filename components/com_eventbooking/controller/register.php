...
class EventbookingControllerRegister extends EventbookingController
{
	...
	protected function validateFormData($eventId, $registrationType, $data)
	{
		...
		$validateResults = Factory::getApplication()->triggerEvent('onEBValidateFormData', [$event, $registrationType, $data]);
	...
	protected function validateTickets($event, $input, &$data, $waitingListEnabled)
	{
		...
		foreach ($ticketTypes as $ticketType)
		{
			...
			{
				$errors[] = Text::sprintf('EB_MINIMUM_QUANTITY_REQUIRED_WARNING', $ticketType->min_tickets_per_booking, $ticketType->title);
			}
