...
class Clockwork
{
    ...
    */
    public function checkBalance()
    {
        ...
        return [ 'symbol' => $symbol, 'balance' => $balance, 'code' => $code, 'account_type' => $account_type ];
    }
