...
<div class="uk-placeholder filemanager-link-options">
  ...
  <div class="uk-grid uk-grid-small uk-form-row">
    ...
    <div class="uk-width-4-5 uk-form-row uk-flex uk-flex-nowrap" id="layout">

      <div class="uk-form-controls uk-width-1-5" id="layout_icon" data-type="icon">
        <div class="uk-panel uk-panel-box uk-width-1-1">
          <label class="uk-form-label uk-width-1-1 uk-margin-right">
            <input type="checkbox" id="layout_icon_check" class="uk-margin-right" />
            <?php echo Text::_('WF_FILEMANAGER_LAYOUT_ICON'); ?>
          </label>
        </div>
      </div>

      <div class="uk-form-controls uk-width-2-5" id="layout_text" data-type="text">
        <div class="uk-panel uk-panel-box uk-width-1-1">
          <label class="uk-form-label uk-width-1-1 uk-margin-right">
            <input type="checkbox" id="layout_text_check"  class="uk-margin-right" checked disabled />
            <?php echo Text::_('WF_FILEMANAGER_LAYOUT_TEXT'); ?>
          </label>
        </div>
      </div>

      <div class="uk-form-controls uk-width-1-1" id="layout_size" data-type="size">
        <div class="uk-panel uk-panel-box uk-width-1-1">
          <label class="uk-form-label uk-width-2-5">
            <input type="checkbox" id="layout_size_check" class="uk-margin-right" />
            <?php echo Text::_('WF_FILEMANAGER_LAYOUT_SIZE'); ?>
          </label>
          <div class="uk-form-icon uk-form-icon-flip uk-width-3-5">
            <input type="text" value="" />
            <a title="<?php echo Text::_('WF_FILEMANAGER_LAYOUT_RELOAD'); ?>" class="uk-icon-refresh layout_option_reload"></a>
          </div>
        </div>
      </div>

      <div class="uk-form-controls uk-width-1-1" id="layout_date" data-type="date">
        <div class="uk-panel uk-panel-box uk-width-1-1">
          <label class="uk-form-label uk-width-2-5">
            <input type="checkbox" id="layout_date_check" class="uk-margin-right" />
