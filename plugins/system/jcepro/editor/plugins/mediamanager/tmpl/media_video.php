...
<div class="media_option video">
    ...
    <div class="uk-form-row uk-flex">
        <label for="video_autoplay" class="uk-checkbox-label"><input type="checkbox" id="video_autoplay" /> <?php echo Text::_('WF_MEDIAMANAGER_LABEL_AUTOPLAY'); ?></label>
        <label for="video_controls" class="uk-checkbox-label"><input type="checkbox" id="video_controls" checked="checked" /> <?php echo Text::_('WF_MEDIAMANAGER_LABEL_CONTROLS'); ?></label>
        <label for="video_loop" class="uk-checkbox-label"><input type="checkbox" id="video_loop" /> <?php echo Text::_('WF_MEDIAMANAGER_LABEL_LOOP'); ?></label>
        <label for="video_muted" class="uk-checkbox-label"><input type="checkbox" id="video_muted" /> <?php echo Text::_('WF_MEDIAMANAGER_VIDEO_MUTE'); ?></label>
    </div>

    <div class="uk-form-row uk-flex">
        <label for="video_preload" class="uk-form-label uk-width-1-1 uk-width-small-1-5"><?php echo Text::_('WF_MEDIAMANAGER_LABEL_PRELOAD'); ?></label>
    ...
    <div class="uk-form-row uk-flex">
        <label for="video_poster" class="uk-form-label uk-width-1-1 uk-width-small-1-5"><?php echo Text::_('WF_MEDIAMANAGER_VIDEO_POSTER'); ?></label>
        <div class="uk-form-controls uk-width-1-1 uk-width-small-4-5">
            <input type="text" id="video_poster" class="browser image" />
        </div>
    </div>
    <div class="uk-form-row uk-flex">
        <label for="video_source" class="uk-form-label uk-width-1-1 uk-width-small-1-5"><?php echo Text::_('WF_MEDIAMANAGER_LABEL_SOURCE'); ?></label>
        <div class="uk-form-controls uk-width-1-1 uk-width-small-4-5">
    ...
    <div class="uk-form-row uk-flex">
        <label for="video_attributes" class="uk-form-label uk-width-1-1 uk-width-small-1-5"><?php echo Text::_('WF_LABEL_ATTRIBUTES'); ?></label>
        <div class="uk-form-controls uk-width-1-1 uk-width-small-4-5 uk-flex-wrap" id="video_attributes">
