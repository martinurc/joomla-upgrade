...
<div class="akeeba-form-group">
	<label for="itemidshield"
		   rel="akeeba-sticky-tooltip"
		   data-original-title="@lang('COM_ADMINTOOLS_CONFIGUREWAF_LBL_OPT_ITEMIDSHIELD')"
		   data-content="@lang('COM_ADMINTOOLS_CONFIGUREWAF_LBL_OPT_ITEMIDSHIELD_TIP')"
	>
		@lang('COM_ADMINTOOLS_CONFIGUREWAF_LBL_OPT_ITEMIDSHIELD')
	</label>

	@jhtml('FEFHelp.select.genericlist', \Akeeba\AdminTools\Admin\Helper\Select::getItemIDShieldOptions(), 'itemidshield', ['list.select' => $this->wafconfig['itemidshield']])
</div>

<div class="akeeba-form-group">
	<label for="suspicious_params"
		   rel="akeeba-sticky-tooltip"
		   data-original-title="@lang('COM_ADMINTOOLS_CONFIGUREWAF_LBL_OPT_SUSPICIOUS_PARAMS')"
		   data-content="@lang('COM_ADMINTOOLS_CONFIGUREWAF_LBL_OPT_SUSPICIOUS_PARAMS_TIP')"
	>
		@lang('COM_ADMINTOOLS_CONFIGUREWAF_LBL_OPT_SUSPICIOUS_PARAMS')
	</label>

	@jhtml('FEFHelp.select.booleanswitch', 'suspicious_params', $this->wafconfig['suspicious_params'])
</div>
