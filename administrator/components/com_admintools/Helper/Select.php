...
class Select
{
	...
	public static function getHstsOptions()
	{
		return [
			HTMLHelper::_('FEFHelp.select.option', '0', Text::_('COM_ADMINTOOLS_HTACCESSMAKER_LBL_HSTSHEADER_OPT_NONE')),
			HTMLHelper::_('FEFHelp.select.option', '1', Text::_('COM_ADMINTOOLS_HTACCESSMAKER_LBL_HSTSHEADER_OPT_BASIC')),
			HTMLHelper::_('FEFHelp.select.option', '2', Text::_('COM_ADMINTOOLS_HTACCESSMAKER_LBL_HSTSHEADER_OPT_PRELOAD')),
		];
	}

	public static function getItemIDShieldOptions()
	{
		return [
			HTMLHelper::_('FEFHelp.select.option', '0', Text::_('COM_ADMINTOOLS_CONFIGUREWAF_LBL_OPT_ITEMIDSHIELD_OFF')),
			HTMLHelper::_('FEFHelp.select.option', '1', Text::_('COM_ADMINTOOLS_CONFIGUREWAF_LBL_OPT_ITEMIDSHIELD_BLOCK')),
			HTMLHelper::_('FEFHelp.select.option', '2', Text::_('COM_ADMINTOOLS_CONFIGUREWAF_LBL_OPT_ITEMIDSHIELD_CLEAN')),
		];
	}
