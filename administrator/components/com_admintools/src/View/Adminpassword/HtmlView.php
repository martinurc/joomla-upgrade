...
class HtmlView extends BaseHtmlView
{
	...
	protected function onBeforeMain()
	{
		...
		$this->resetErrorPages = (bool) $app->getUserStateFromRequest('com_admintools.adminpassword.resetErrorPages', 'resetErrorPages', 1, 'int');
		$this->mode = $app->getUserStateFromRequest('com_admintools.adminpassword.mode', 'mode', 'everything', 'cmd');
		$this->hashtype = $app->getUserStateFromRequest('com_admintools.adminpassword.hashtype', 'hashtype', 'apr1', 'cmd');
