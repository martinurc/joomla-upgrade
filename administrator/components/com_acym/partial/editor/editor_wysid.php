        ...
        <?php if ('joomla' === ACYM_CMS) { ?>
			<div id="acym__wysid__modal__joomla-image">
				...
				<div id="acym__wysid__modal__joomla-image__ui" class="float-center cell">
                    ...
                    ?>
					<iframe
                            id="acym__wysid__modal__joomla-image__ui__iframe"
                    ...
                    <div id="acym__wysid__modal__joomla-image__ui__actions" class="cell grid-x grid-margin-x align-right" style="display: none">
