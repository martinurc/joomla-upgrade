        ...
        if (!empty($licenseKey)) { ?>
			...
			<div class="margin-y">
				<div class="cell grid-x grid-margin-x acym_vcenter">
					<label class="cell medium-3"><?php echo acym_translation('ACYM_AUTOMATED_TASKS').acym_info('ACYM_AUTOMATED_TASKS_DESC'); ?></label>
                    <?php
				...
				<div class="cell grid-x grid-margin-x acym_vcenter">
					<label class="cell medium-3"><?php echo acym_translation('ACYM_EXECUTE_DAILY_TASKS').acym_info('ACYM_DAILY_TASKS_DESC'); ?></label>
                ...
                if ($expirationDate > time()) {
                    ...
                    ?>
					<div class="cell grid-x grid-margin-x acym_vcenter">
						<label class="cell medium-3"><?php echo acym_translation('ACYM_CRON_URL').acym_info('ACYM_CRON_URL_DESCRIPTION'); ?></label>
