	...
	<div class="acym__content acym_area padding-horizontal-2 acym__configuration__advanced">
		...
		<div id="acym__configuration__queue__advanced__content" style="display:none;">
			<div class="margin-bottom-2">
				...
				<div class="grid-x grid-margin-x margin-y">
					<div class="cell large-2 medium-3"><label for="cronsendreport"><?php echo acym_translation('ACYM_REPORT_SEND').acym_info('ACYM_REPORT_SEND_DESC'); ?></label>
					</div>
					...
					<div class="cell large-2 medium-3">
						<label for="cron_sendto"><?php echo acym_translation('ACYM_REPORT_SEND_TO').acym_info('ACYM_REPORT_SEND_TO_DESC'); ?></label>
					</div>
					<div class="cell large-4 medium-9">
                        <?php
                        $emails = [];
					...
					<div class="cell large-2 medium-3">
						<label for="cronsavereport"><?php echo acym_translation('ACYM_REPORT_SAVE').acym_info('ACYM_REPORT_SAVE_DESC'); ?></label>
					</div>
					<div class="cell large-4 medium-9">
                        <?php
                        echo acym_select(
					...
					<div class="cell large-2 medium-3">
						<label for="cron_savepath"><?php echo acym_translation('ACYM_REPORT_SAVE_TO').acym_info('ACYM_REPORT_SAVE_TO_DESC'); ?></label>
					</div>
					<div class="cell large-4 medium-9">
						<input id="cron_savepath" type="text" name="config[cron_savepath]" value="<?php echo acym_escape($this->config->get('cron_savepath')); ?>">
					</div>
					<div class="cell">
						<button type="submit" data-task="deletereport" class="margin-right-1 button acy_button_submit">
			...
			<div class="">
				...
				<div class="grid-x grid-margin-x margin-y">
					<div class="cell medium-2"><?php echo acym_translation('ACYM_LAST_RUN').acym_info('ACYM_LAST_RUN_DESC'); ?></div>
					<div class="cell medium-9">
                        <?php
					...
					<div class="cell medium-2"><?php echo acym_translation('ACYM_CRON_TRIGGERED_IP').acym_info('ACYM_CRON_TRIGGERED_IP_DESC'); ?></div>
					<div class="cell medium-9">
                        <?php echo $this->config->get('cron_fromip'); ?>
					</div>
					<div class="cell medium-2"><?php echo acym_translation('ACYM_REPORT').acym_info('ACYM_REPORT_DESC'); ?></div>
					<div class="cell medium-9">
