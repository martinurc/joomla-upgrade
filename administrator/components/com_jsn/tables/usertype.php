...
class JsnTableUsertype extends JTableNested
{
	/**
	 * Constructor
	 *
	...
	{
		parent::__construct('#__jsn_usertypes', 'id', $db);
	}
	...
	public function check()
	{
		...
		{
			$this->alias = JDate::getInstance()->format("Y-m-d-H-i-s");
		}
	...
	public function store($updateNulls = false)
	{
		...
		$table = JTable::getInstance('Usertype', 'JsnTable');
