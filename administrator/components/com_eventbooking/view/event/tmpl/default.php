...
{
	HTMLHelper::_('formbehavior.chosen', '.advancedSelect', null, ['placeholder_text_multiple' => Text::_('EB_SELECT_CATEGORIES')]);
...
Factory::getApplication()->getDocument()->addScript(Uri::root(true) . '/media/com_eventbooking/js/admin-event-default.min.js');
...
<form action="<?php echo $this->getFormAction(); ?>" method="post" name="adminForm" id="adminForm"
	...
	<?php echo HTMLHelper::_($tabApiPrefix . 'startTabSet', 'event', ['active' => 'basic-information-page', 'recall' => true]); ?>
	<?php echo HTMLHelper::_($tabApiPrefix . 'addTab', 'event', 'basic-information-page', Text::_('EB_BASIC_INFORMATION')); ?>
	...
	{
		echo HTMLHelper::_($tabApiPrefix . 'addTab', 'event', 'discount-page', Text::_('EB_DISCOUNT_SETTING'));
	...
	{
		echo HTMLHelper::_($tabApiPrefix . 'addTab', 'event', 'extra-information-page', Text::_('EB_EXTRA_INFORMATION'));
	?>
	...
	{
		echo HTMLHelper::_($tabApiPrefix . 'addTab', 'event', 'tickets-page', Text::_('EB_TICKETS_SETTINGS'));
	...
	{
		echo HTMLHelper::_($tabApiPrefix . 'addTab', 'event', 'certificate-page', Text::_('EB_CERTIFICATE_SETTINGS'));
	...
	{
		echo HTMLHelper::_($tabApiPrefix . 'addTab', 'event', 'advance-settings-page', Text::_('EB_ADVANCED_SETTINGS'));
	...
	{
		echo HTMLHelper::_($tabApiPrefix . 'addTab', 'event', 'messages-page', Text::_('EB_MESSAGES'));
	...
	if (count($this->plugins))
	{
		...
		{
			$count++;
			echo HTMLHelper::_($tabApiPrefix . 'addTab', 'event', 'tab_' . $count, Text::_($plugin['title']));
			echo $plugin['form'];
			echo HTMLHelper::_($tabApiPrefix . 'endTab');
		}
	}
	...
	{
		echo HTMLHelper::_($tabApiPrefix . 'addTab', 'event', 'custom-settings-page', Text::_('EB_EVENT_CUSTOM_SETTINGS'));
