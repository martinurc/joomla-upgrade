...
<table class="table table-striped table-bordered">
	...
	<tbody>
		...
		<tr>
			<td>
				<?php echo Text::_('EB_TOTAL_CANCELLATION'); ?>
			</td>
			<td class="center">
				<?php echo $this->data['total_cancellation']['total_registrants']; ?>
			</td>
			<td>
				<?php echo EventbookingHelper::formatCurrency($this->data['total_cancellation']['total_amount'], $config) ?>
			</td>
		</tr>
	</tbody>
</table>