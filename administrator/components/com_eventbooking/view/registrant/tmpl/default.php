...
<form action="<?php echo $this->getFormAction(); ?>" method="post" name="adminForm" id="adminForm" class="form form-horizontal" enctype="multipart/form-data">
	...
	{
		echo HTMLHelper::_($tabApiPrefix . 'startTabSet', 'registrant', ['active' => 'general-page', 'recall' => true]);
		echo HTMLHelper::_($tabApiPrefix . 'addTab', 'registrant', 'general-page', Text::_('EB_GENERAL'));
	}
	?>
	...
	if ($hasCustomSettings)
	{
		...
		echo HTMLHelper::_($tabApiPrefix . 'addTab', 'registrant', 'custom-settings-page', Text::_('EB_REGISTRANT_CUSTOM_SETTINGS'));
