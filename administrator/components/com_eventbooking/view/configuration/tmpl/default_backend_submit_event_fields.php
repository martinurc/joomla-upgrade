...
<div class="control-group">
	<div class="control-label">
		<?php echo EventbookingHelperHtml::getFieldLabel('bes_show_image_alt', Text::sprintf('EB_FES_SUBMIT_EVENT', Text::_('EB_IMAGE_ALT'))); ?>
	</div>
	<div class="controls">
		<?php echo EventbookingHelperHtml::getBooleanInput('bes_show_image_alt', $config->get('bes_show_image_alt', 1)); ?>
	</div>
</div>
<div class="control-group">
	<div class="control-label">
...
<div class="control-group">
	<div class="control-label">
		<?php echo EventbookingHelperHtml::getFieldLabel('bes_show_private_booking_count', Text::sprintf('EB_FES_SUBMIT_EVENT', Text::_('EB_PRIVATE_BOOKING_COUNT'))); ?>
	</div>
	<div class="controls">
		<?php echo EventbookingHelperHtml::getBooleanInput('bes_show_private_booking_count', $config->get('bes_show_private_booking_count', 1)); ?>
	</div>
</div>
<div class="control-group">
	<div class="control-label">
...
<div class="control-group">
	<div class="control-label">
        <?php echo EventbookingHelperHtml::getFieldLabel('bes_show_event_detail_url', Text::sprintf('EB_FES_SUBMIT_EVENT', Text::_('EB_CUSTOM_EVENT_DETAIL_URL'))); ?>
	</div>
	<div class="controls">
        <?php echo EventbookingHelperHtml::getBooleanInput('bes_show_event_detail_url', $config->get('bes_show_event_detail_url', 0)); ?>
	</div>
</div>
<div class="control-group">
	<div class="control-label">
