...
<div class="<?php echo $bootstrapHelper->getClassMapping('row-fluid'); ?>">
	<div class="<?php echo $bootstrapHelper->getClassMapping('span6'); ?>">
		...
		<fieldset class="form-horizontal options-form">
			...
			<div class="control-group">
				...
				<div class="controls">
					<?php echo $this->lists['send_event_attachments']; ?>
				</div>
			</div>
			<div class="control-group">
				<div class="control-label">
			...
			<div class="control-group">
				<div class="control-label">
					<?php echo EventbookingHelperHtml::getFieldLabel('activate_transparent', Text::_('EB_ACTIVATE_TRANSPARENT'), Text::_('EB_ACTIVATE_TRANSPARENT_EXPLAIN')); ?>
				</div>
				<div class="controls">
					<?php echo EventbookingHelperHtml::getBooleanInput('activate_transparent', $config->activate_transparent); ?>
				</div>
			</div>
		</fieldset>
	</div>
	...
	<div class="<?php echo $bootstrapHelper->getClassMapping('span6'); ?>">
		<fieldset class="form-horizontal options-form">
			...
			<div class="control-group">
				<div class="control-label">
					<?php echo EventbookingHelperHtml::getFieldLabel('number_events_per_row', Text::_('EB_EVENTS_PER_ROW'), Text::_('EB_EVENTS_PER_ROW_EXPLAIN')); ?>
				</div>
				<div class="controls">
					<input type="number" name="number_events_per_row" class="form-control" value="<?php echo $config->get('number_events_per_row', 2); ?>" size="10" />
				</div>
			</div>
			<div class="control-group">
				<div class="control-label">
			...
			<div class="control-group">
				<div class="control-label">
					<?php echo EventbookingHelperHtml::getFieldLabel('show_category_in_table_layout', Text::_('EB_SHOW_CATEGORY_IN_TABLE_LAYOUT')); ?>
				</div>
				<div class="controls">
					<?php echo EventbookingHelperHtml::getBooleanInput('show_category_in_table_layout', $config->show_category_in_table_layout); ?>
				</div>
			</div>
			<div class="control-group">
				<div class="control-label">
		...
		<fieldset class="form-horizontal options-form">
			...
			<div class="control-group">
				<div class="control-label">
                    <?php echo EventbookingHelperHtml::getFieldLabel('show_back_button', Text::_('EB_SHOW_BACK_BUTTON')); ?>
				</div>
				<div class="controls">
                    <?php echo EventbookingHelperHtml::getBooleanInput('show_back_button', $config->get('show_back_button', 1)); ?>
				</div>
			</div>
		</fieldset>
		<fieldset class="form-horizontal options-form">
			...
			<div class="control-group">
				<div class="control-label">
                    <?php echo EventbookingHelperHtml::getFieldLabel('public_registrants_list_number_registrants', Text::_('EB_REGISTRANTS_PER_PAGE')); ?>
				</div>
				<div class="controls">
                    <input type="number" name="public_registrants_list_number_registrants" class="form-control" value="<?php echo $this->config->get('public_registrants_list_number_registrants', Factory::getApplication()->get('list_limit')); ?>" />
				</div>
			</div>
		</fieldset>
		<fieldset class="form-horizontal options-form">
			...
			<div class="control-group">
				<div class="control-label">
					<?php echo EventbookingHelperHtml::getFieldLabel('history_show_first_name', Text::sprintf('EB_SHOW_FIELD', Text::_('EB_FIRST_NAME'))); ?>
				</div>
				<div class="controls">
					<?php echo EventbookingHelperHtml::getBooleanInput('history_show_first_name', $config->get('history_show_first_name', 1)); ?>
				</div>
			</div>
			<div class="control-group">
				<div class="control-label">
					<?php echo EventbookingHelperHtml::getFieldLabel('history_show_last_name', Text::sprintf('EB_SHOW_FIELD', Text::_('EB_LAST_NAME'))); ?>
				</div>
				<div class="controls">
					<?php echo EventbookingHelperHtml::getBooleanInput('history_show_last_name', $config->get('history_show_last_name', 1)); ?>
				</div>
			</div>
			<div class="control-group">
				<div class="control-label">
		...
		<fieldset class="form-horizontal options-form">
			...
			<div class="control-group">
				<div class="control-label">
                    <?php echo EventbookingHelperHtml::getFieldLabel('allow_changing_number_registrants', Text::_('EB_ALLOW_CHANGING_NUMBER_REGISTRANTS')); ?>
				</div>
				<div class="controls">
                    <?php echo EventbookingHelperHtml::getBooleanInput('allow_changing_number_registrants', $config->get('allow_changing_number_registrants', 0)); ?>
				</div>
			</div>
		</fieldset>
		<fieldset class="form-horizontal options-form">
			<legend><?php echo Text::_('EB_EVENTS_MANAGEMENT'); ?></legend>
			<?php $this->boolean('show_event_creator_on_events_management', 'EB_SHOW_EVENT_CREATOR'); ?>
		</fieldset>
	</div>
</div>
