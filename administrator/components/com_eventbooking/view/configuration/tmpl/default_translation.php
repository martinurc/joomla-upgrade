...
echo HTMLHelper::_($tabApiPrefix . 'addTab', 'configuration', 'invoice-translation', Text::_('EB_TRANSLATION'));
echo HTMLHelper::_($tabApiPrefix . 'startTabSet', 'invoice-translation',
