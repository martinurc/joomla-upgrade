...
?>
<form action="<?php echo $this->getFormAction(); ?>" method="post" name="adminForm" id="adminForm" class="adminform form form-horizontal">
...
<div class="<?php echo $span5Class; ?>">
	<fieldset class="form-horizontal options-form">
		...
		{
			echo HTMLHelper::_($tabApiPrefix . 'startTabSet', 'payment-plugin-params', ['active' => 'basic', 'recall' => true]);
