...
<form action="<?php echo $this->getFormAction(); ?>" method="post" name="adminForm" id="adminForm" class="form form-horizontal">
	...
	{
		echo HTMLHelper::_($tabApiPrefix . 'startTabSet', 'coupon', ['active' => 'coupon-page', 'recall' => true]);
		echo HTMLHelper::_($tabApiPrefix . 'addTab', 'coupon', 'coupon-page', Text::_('EB_BASIC_INFORMATION'));
	}
	?>
	...
	if (!empty($this->registrants))
	{
		...
		echo HTMLHelper::_($tabApiPrefix . 'addTab', 'coupon', 'registrants-page', Text::_('EB_COUPON_USAGE'));
