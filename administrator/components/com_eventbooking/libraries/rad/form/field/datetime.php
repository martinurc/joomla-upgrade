...
class RADFormFieldDatetime extends RADFormField
{
	/**
	 * The form field type.
	 *
	...
	public function setValue($value)
	{
		...
		if ($value
			&& (strpos($value, 'day') !== false
				|| strpos($value, 'week') !== false
				|| strpos($value, 'month') !== false
				|| strpos($value, 'month') !== false)
		)
		{
			try
	...
	public function getDisplayValue()
	{
		...
		try
		{
			...
			$fieldValue = $date->format($dateFormat.' H:i');
		}
		catch (Exception $e)
		{
